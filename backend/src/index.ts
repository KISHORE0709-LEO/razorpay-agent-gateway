...
import { handleGetRules, handleSaveRules, handleGetPolicyStrategies, handleResetDailySpend, handleResetAgentTrust, handleAlignChain } from "./routes/rules";
...
app.post("/api/rules/reset-agent-trust", handleResetAgentTrust);
app.post("/api/audit/align", handleAlignChain);
